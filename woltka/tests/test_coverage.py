...
class CoverageTests(TestCase):
    ...
    def test_parse_ranges(self):
        ...
        exp = {('S1', 'G1'): [4, (1, 100), (1, 50), (251, 300), (1, 50)],
               ('S1', 'G2'): [1, (101, 150)],
               ('S2', 'G2'): [3, (151, 200), (51, 100), (26, 75)],
               ('S2', 'G3'): [2, (76, 125), (1, 50)],
               ('S2', 'G4'): [2, (26, 75), (101, 150)],
               ('S3', 'G1'): [4, (1, 50), (51, 100), (151, 200), (101, 150)],
               ('S3', 'G2'): [2, (51, 100), (1, 50)]}
    ...
    def test_calc_coverage(self):
        cov = {('S1', 'G1'): [4, (1, 100), (1, 50), (251, 300), (1, 50)],
               ('S1', 'G2'): [1, (101, 150)],
               ('S2', 'G2'): [3, (151, 200), (51, 100), (26, 75)],
               ('S2', 'G3'): [2, (76, 125), (1, 50)],
               ('S2', 'G4'): [2, (26, 75), (101, 150)],
        ...
        exp = {'S1': {'G1': [(1, 100), (251, 300)], 'G2': [(101, 150)]},
               'S2': {'G2': [(26, 100), (151, 200)], 'G3': [(1, 50), (
                   76, 125)], 'G4': [(26, 75), (101, 150)]},
               'S3': {'G1': [(1, 200)], 'G2': [(1, 100)]}}
        self.assertDictEqual(obs, exp)

    def test_write_coverage(self):
        cov = {'S1': {'G1': [(1, 100), (251, 300)], 'G2': [(101, 150)]},
               'S2': {'G2': [(26, 100), (151, 200)], 'G3': [(1, 50), (
                   76, 125)], 'G4': [(26, 75), (101, 150)]},
               'S3': {'G1': [(1, 200)], 'G2': [(1, 100)]}}
